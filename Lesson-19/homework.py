...
with open("text_files\data.txt", encoding='utf-8') as file:
    # 2. Читаем весь контент файла и выводим его на экран
    print("Содержимое файла:")
    print(file.read())

with open("text_files\data.txt", 'r', encoding='utf-8') as file:
    # 3. Читаем первые 10 символов файла и выводим их на экран
    # first_10_chars = file.read(10)
    print("Первые 10 символов файла:")
    print(file.read(10))

with open("text_files\data.txt", 'r', encoding='utf-8') as file:
    # 4. Читаем одну строку из файла и выводим ее на экран
    # first_line = file.readline()
    print("Первая строка файла:")
    print(file.readline())

with open("text_files\data.txt", 'r', encoding='utf-8') as file:
    # 5. Читаем все строки файла и выводим их на экран
    all_lines = file.readlines()
    print("Все строки файла:")
    for line in all_lines:
        print(line.strip())  # Используем strip() для удаления лишних переносов строк
