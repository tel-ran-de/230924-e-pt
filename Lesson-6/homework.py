...
#     - [x ] операция будет просто проигнорирована и программа продолжит выполняться дальше
...
# s1, s2 = input("Введите два слова через пробел").split()
...
# print("Aбсолютное значение:", abs(int(s1)))
#
...
# a = input("Введите число 1:")
# b = input("Введите число 2:")
# print("Мeньшее число:", min(int(a), int(b)))
#
