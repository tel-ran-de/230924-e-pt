...
films1=["Movie1", "Movie2", "Movie3", "Movie4"]
films2=["Movie5", "Movie6", "Movie7"]
if len(films1) >=2 :
    films1[1]="Updated Movie2"
    print(films1)
if len(films1) <=5:
    films1.extend(films2)
    print(films1)
...
Films_top.insert(0, "Movie, 2002, 7.7" )
print(Films_top)
...
print(list_kurs[0][1]+ list_kurs[1][1]+ list_kurs[2][1]+list_kurs[3][1]  )
