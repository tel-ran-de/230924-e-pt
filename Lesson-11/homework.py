...
print("-------Упражнение 2: Таблица умножения-------")
...
print("-------Генераторы списков. Упражнение 1.------------------")
list_div7 = [x for x in range(7,1001, 7)]
print(list_div7)
...
print("--------------------- Упражнение 2.-----------------------")
list_find_3 = [x for x in range(1,1001) if str(x).find('3') >= 0]
print(list_find_3)
...
print("--------------------- Упражнение 4.-----------------------")
some_string = "the quick brown fox jumps over the lazy dog"
letter_list = [x for x in some_string if x in "aoeiu"]
print(letter_list)

# Упражнение 5: Сумма элеменовт в каждом ряду матрицы
...
print("--------------------- Упражнение 6.-----------------------")
print(matrix)
even_odd_count = [[sum(1 for numb in row if numb % 2 == 0), sum(1 for numb in row if numb % 2 == 1)] for row in matrix]
for row in even_odd_count:
    print(f"Количество четных чисел = {row[0]}, нечетных чисел = {row[1]}")
