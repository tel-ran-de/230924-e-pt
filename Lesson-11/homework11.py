...
# num_div7 = [num for num in range(1, 1001) if num % 7 == 0]
# print(num_div7)
...
# gls = [char for char in some_string if char in 'aeiou']
# print(gls)
...
#     [38, 41, 44, 47],
# ]
# chetn = sum(len([i for i in j if i % 2 == 0]) for j in matrix)
# print(f"Количество четных чисел:  ", chetn)
#
# nechetn = sum(len([i for i in j if i % 2 != 0]) for j in matrix)
# print(f"Количество нечетных чисел: ", nechetn)
# print(sum([len([element for element in row if element % 2 ==0 ]) for row in matrix]))
...
# ]
#
# maksim = [[element for element in row if max(matrix)] for row in matrix]
# print(maksim)
...
# matrix1 = [[i for i in range(1+3*j, 1+3*(j+1))] for j in range(3)]
# print(matrix1)
#
#
# matrix2 = [[i for i in range(3*j, 3*(j-1), -1)] for j in range(3, 0, -1)]
# print(matrix2)
#
#
